      ...
      <>
          ...
          <SectionMain>
            ...
            <CardBox>
                ...
                <>
                    <p className={'block font-bold mb-2'}>Profiles User</p>
                    <CardBox
                    ...
                    >
                        <div className='overflow-x-auto'>
                            ...
                            <tbody>
                            {users.profiles_user && Array.isArray(users.profiles_user) &&
                              users.profiles_user.map((item: any) => (
                                <tr key={item.id} onClick={() => router.push(`/profiles/profiles-view/?id=${item.id}`)}>
                        ...
                        {!users?.profiles_user?.length && <div className={'text-center py-4'}>No data</div>}
                    </CardBox>
                </>
                ...
                <>
                    ...
                    >
                        <div className='overflow-x-auto'>
                            ...
                            <tbody>
                            {users.tasks_assigned_user && Array.isArray(users.tasks_assigned_user) &&
                        ...
                        {!users?.tasks_assigned_user?.length && <div className={'text-center py-4'}>No data</div>}
                    </CardBox>
                </>
