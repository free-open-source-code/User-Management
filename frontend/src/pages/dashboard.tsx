...
const Dashboard = () => {
    ...
    async function loadData() {
        const entities = ['users','profiles','tasks','roles','permissions',];
        const fns = [setUsers,setProfiles,setTasks,setRoles,setPermissions,];
                    ...
                    <div className="flex justify-between align-center">
                        ...
                        <div>
                            <BaseIcon
                                ...
                                // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                                // @ts-ignore
                                path={'mdiClipboardListOutline' in icon ? icon['mdiClipboardListOutline' as keyof typeof icon] : icon.mdiTable || icon.mdiTable}
                            />
                        </div>
                    </div>
                </div>
