...
const ProfilesView = () => {
    ...
    return (
      <>
          ...
          <SectionMain>
            <SectionTitleLineWithButton icon={mdiChartTimelineVariant} title={removeLastCharacter('View profiles')} main>
                <BaseButton
                  color='info'
                  label='Edit'
                  href={`/profiles/profiles-edit/?id=${id}`}
                />
            ...
            <CardBox>
                ...
                <FormField label='Multi Text' hasTextareaHeight>
                  <textarea className={'w-full'} disabled value={profiles?.bio} />
                </FormField>
