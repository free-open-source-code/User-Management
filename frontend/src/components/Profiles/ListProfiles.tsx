...
const ListProfiles = ({ profiles, loading, onDelete, currentPage, numPages, onPageChange }: Props) => {
                  ...
                  <div key={item.id}>
                    <CardBox hasTable isList className={'rounded shadow-none'}>
                        <div className={`flex rounded dark:bg-dark-900 border items-center overflow-hidden`}>
                          <Link
                              href={`/profiles/profiles-view/?id=${item.id}`}
                              className={
                          ...
                          >
                            ...
                            <div className={'flex-1 px-3'}>
                                <p className={'text-xs text-gray-500'}>ProfilePicture</p>
                                <p className={'line-clamp-2'}>{ item.profile_picture }</p>
                            </div>
