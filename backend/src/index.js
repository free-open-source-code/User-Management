  ...
  definition: {
    openapi: "3.0.0",
      info: {
        ...
        description: "User Management Online REST API for Testing and Prototyping application. You can perform all major operations with your entities - create, delete and etc.",
      },
    servers: [
      {
